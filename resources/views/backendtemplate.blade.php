...
<head>
  ...
  <link href="{{ asset('backendtemplate/css/hover-master/css/hover.css')}}" rel="stylesheet">
...
<body id="page-top">
  ...
  <script src="{{ asset('backendtemplate/sweetalert/dist/sweetalert.min.js')}}"></script>
